...
class GATLayer(nn.Module):
    def __init__(self, in_channels: int, out_channels: int, heads: int = 8, concat: bool = True, dropout: float = 0.6):
        """
        ...
        self.conv = GATConv(in_channels, out_channels // heads, heads=heads, concat=concat, dropout=dropout)
        self.relu = nn.ReLU()
