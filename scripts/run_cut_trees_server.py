...
if __name__ == "__main__":
    ...
    experiment_parent_directory = '/scratch/project/open-26-5/jozefov_147/PhantoMS/experiments_run/full_data_cut_tress_5'
    ...
    wandb_project_name = 'full_data_cut_tress_5'
